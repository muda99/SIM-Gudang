...
class Admin extends CI_Controller{
  ...
  public function get_barang_by_unit()
{
    $unitId = $this->input->get('unit_id');
    $data['list_barang'] = $this->M_admin->get_barang_by_unit($unitId);
  ...
  {
    $data['list_satuan'] = $this->M_admin->select('tb_satuan');
    $data['list_unit'] = $this->M_admin->select('tb_unit');

    $data['list_barang'] = $this->M_admin->select('tb_barang');// supplier
    $data['list_supplier'] = $this->M_admin->select('tb_supplier');// supplier
  ...
  public function update_barang_unit()
  {
    $uri = $this->uri->segment(3);
  ...
  public function delete_barang_unit()
  {
    $uri = $this->uri->segment(3);
    $where = array('id_barang' => $uri);
  ...
  {
    $this->form_validation->set_rules('kode_barang','Kode barang','trim|required|max_length[100]');
  ...
  public function proses_barang_update()
  {
    $this->form_validation->set_rules('kode_barang','Kode barang','trim|required|max_length[100]');
    $this->form_validation->set_rules('nama_barang','Nama barang','trim|required|max_length[100]');
