...
class Report extends CI_Controller
{
  ...
  {
    $data = $this->M_admin->get_data_barang('tb_barang_keluar');
    // Create new PDF document with 4A paper size
...
// Disable auto page breaks and set bottom margin
...
// Add a page with default page size (A4)
$pdf->AddPage();

$data = $this->M_admin->get_data_barang('tb_barang_keluar');

$html = '<div>
                       <h1 style="text-align: center; margin-top: 0;">Invoice Bukti Pengeluaran Barang</h1> 
