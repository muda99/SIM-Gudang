...
<head>
  ...
  <title>Web Gudang | Nama Barang</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= base_url('admin/form_barang')?>"><i class="fa fa-circle-o"></i> Tambah Barang</a></li>
          </ul>
        </li>
        <li class="treeview ">
          <a href="#">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group" style="display:inline-block;">
                  <label for="kode_satuan" style="width:87%;margin-left: 12px;">Kode Barang</label>
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" class="btn btn-info" style="width:13%;margin-right:29%" href="<?=base_url('admin/tabel_barang')?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Barang</a>
